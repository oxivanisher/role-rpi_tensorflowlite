...
| rpi_tensorflowlite_dir       | The target directory where tensorflow lite will be installed in | `{{ rpi_tensorflowlite_user_home }}/tensorflow/tensorflow_src` (home resolved via getent) |
...
| rpi_tensorflowlite_model_dir | The target directory got the downloaded tensorflow model        | `{{ rpi_tensorflowlite_user_home }}/tensorflow/model` (home resolved via getent) |
